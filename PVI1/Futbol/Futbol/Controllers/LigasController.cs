...
namespace Futbol.Controllers
{
    public class LigasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ligaID,nombreLiga,anioFundacion,nombrePais")] Liga liga)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ligaID,nombreLiga,anioFundacion,nombrePais")] Liga liga)
        {
            if (ModelState.IsValid)
            {
